...
<html>
    ...
    <body>
        <div id="container">
            ...
            <div id="conteudo">
                <form method="POST" action="${pageContext.request.contextPath}/controller?opcao=hotel.editarPorId">
                    ...
                    <input type="button" onclick="location.href =
                                    '${pageContext.request.contextPath}/controller?opcao=hotel.listar'" value="Cancelar"/>
                    </select>
                </form>
            </div>
        </div>	
