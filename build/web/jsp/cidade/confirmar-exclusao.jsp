    ...
    <body>
        <div id="container">
            <header>
                ...
                <h1>Confirmar exclusão de cidade</h1>
            </header>
            <div id="conteudo">
                <form method="POST" action="controller?opcao=cidade.excluir">
                    <label for="Codigo">Código:</label>
                    <input type="text" size="6" readonly="true" name="codigo" value="${cidade.codigo}"/>
                    <br/>
                    <label for="nome">Nome:</label>
                    <input type="text" size="40" readonly="true "name="nome" value="${cidade.nome}"/>
                    <br/>
